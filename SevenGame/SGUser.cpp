...
void CSGUser::UpdateUserCard(int iCardNum)
{
	iCardNum += 1;
...
BOOL CSGUser::IHaveIt(int iCardNum, int iCardType)
{	
...
BOOL CSGUser::IsCloseCard(EdgeCard CardLimit,int iCardType)
{
	if(iCardType == TYPE_SPADE)
	{
...
int CSGUser::IsLowCardNum(int Low_Card,int iCardType)
{	
	if(iCardType == TYPE_CLOVER)
	{
		if( Low_Card == 1 )
...
BOOL CSGUser::IsHighCardNum(int High_Card,int iCardType)
{	
	if(iCardType == TYPE_CLOVER)
	{
...
void CSGUser::EliminateCard(int iCardNum, int iCardType)
{
...
void CSGUser::SendUserCardToTable()
{
	CSGManager *pManager = GetGameManager();
	CSGTable *pTable = pManager->GetTable();
